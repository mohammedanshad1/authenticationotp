...
void main() {
  runApp(DevicePreview(
    builder: (BuildContext context) => MaterialApp(
      ...
      home: register_with_validate(),
    ),
  ));
}

class register_with_validate extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => register_with_validate_State();
}

class register_with_validate_State extends State<register_with_validate> {
String? email;
String? pass;
String? cpass;
